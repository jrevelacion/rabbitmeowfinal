...
const DiscordButton = () => {
  const handleDiscordRedirect = () => {
    window.open('https://discord.gg/SCdG4eBd', '_blank', 'noopener,noreferrer');
  };

  return (
    <div className="fixed bottom-20 right-4 sm:bottom-24 sm:right-5 z-50">
      <motion.button
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.9 }}
        onClick={handleDiscordRedirect}
        className="p-3 sm:p-4 bg-[#5865F2] rounded-full shadow-xl hover:bg-[#4752C4] transition-all duration-200"
